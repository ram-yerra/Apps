/**
 * @class Ext.fx2.Animator
 * @extends Ext.util.Observable
 * Animation instance
 */

Ext.ns('Ext.fx2');
Ext.fx2.Animator = Ext.extend(Ext.util.Observable, {
    /**
     * @cfg {Number} duration
    ...
    /**
     * @cfg {Ext.fx2.target} target
     * The Ext.fx2.target to apply the animation to.  If not specified during initialization, this can be passed to the applyAnimator
...
keyframes : {
    ...
    /**
     * Applies animation to the Ext.fx2.target
     * @param target
     * @type string/object
     */
    applyAnimator: function(target) {
        target = Ext.fx2.Manager.createTarget(target);
        var anims = [],
            anim,
