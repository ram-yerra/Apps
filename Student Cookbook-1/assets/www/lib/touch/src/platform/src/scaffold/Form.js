...
Ext.scaffold.Form = Ext.extend(Ext.form.FormPanel, {
    ...
    /**
     * @cfg {String} titleFormat A string suitable for passing into Ext.util.Format.format to generate the title text
     */
    titleFormat: "Edit {0}",
    ...
    initComponent: function() {
        Ext.applyIf(this, {
            ...
            title: Ext.util.Format.format(this.titleFormat, this.model.modelName),
