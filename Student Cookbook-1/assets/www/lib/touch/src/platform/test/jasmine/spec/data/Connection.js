describe("Ext.data.Connection", function(){
    ...
    describe("async", function(){
        ...
        it("should use whatever is specified in the options", function(){
            ...
            expect(request.xhr.ajaxOptions.async).toBeFalsy();
        });
    ...
    describe("headers", function(){
        ...
        describe("content type", function(){
            ...
            it("should not set the content type iif we have no data/params", function(){
                makeConnection();
                request = connection.request({
                    url: 'foo'
                });
    ...
    describe("isLoading", function(){
        it("should return false if no request is passed", function(){
            makeConnection();
            expect(connection.isLoading()).toBeFalsy();
        });
        ...
        it("should return true if the request is loading", function(){
            ...
            expect(connection.isLoading(request)).toBeTruthy();
        });
       ...
       it("should return false if the request has loaded", function(){
            ...
            request = connection.mockComplete({
                status: 200
            });
            expect(connection.isLoading(request)).toBeFalsy();
        });
    ...
    describe("aborting", function(){
        ...
        it("should abort all requests if a specific one isn't specified", function(){
            makeConnection();
