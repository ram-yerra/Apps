describe("Ext.util.Region", function() {
    ...
    beforeEach(function() {
        region1 = new Ext.util.Region(2, 5, 6, 1);
        region2 = new Ext.util.Region(1, 6, 3, 4);
        region3 = new Ext.util.Region(0, 2, 2, 0);
        region4 = new Ext.util.Region(3, 4, 5, 2);
        region5 = new Ext.util.Region(7, 3, 9, 1);
    });
