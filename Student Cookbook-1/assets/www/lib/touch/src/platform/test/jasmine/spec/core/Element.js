describe("Ext.Element", function() {
    ...
    describe("methods", function() {
        ...
        describe("listeners", function() {
            ...
            describe("purgeAllListener", function() {
                it("should call Ext.EventManager.purgeElement", function() {
                    ...
                    expect(Ext.EventManager.purgeElement).toHaveBeenCalledWith(element, true);
                });
            });
        });
        ...
        describe("load", function() {
            ...
            describe("with object as first argument", function() {
                it("should call Ext.Ajax.request", function() {
                    element.load({
                        url: "somewhere",
                        params: {
                            foo: true,
                ...
                it("should set indicatorText to empty string if it isn't defined", function() {
                    element.load({
                        url: "somewhere",
                        params: {
                            foo: true,
            ...
            describe("with string as firt argument", function() {
                it("should call Ext.Ajax.request", function() {
                    element.load("somewhere", {foo: true, bar: false}, Ext.emptyFn);
        ...
        describe("contains", function() {
            ...
            beforeEach(function() {
                spyOn(Ext.lib.Dom, "isAncestor");
                element2 = element.createChild({tag: "div"});
            });

            it("should call Ext.lib.Dom.isAncestor if passed argument is an existing element", function() {
                element.contains(element2);

                expect(Ext.lib.Dom.isAncestor).toHaveBeenCalledWith(element.dom, element2.dom);
            });

            it("should not call Ext.lib.Dom.isAncestor if passed argument is not an existing element", function() {
                element.contains(null);

                expect(Ext.lib.Dom.isAncestor).not.toHaveBeenCalled();
            });

            it("should return false if passed argument is not an existing element", function() {
        ...
        describe("update", function() {
            ...
            it("should update dom element innerHTML", function() {
                ...
                expect(element.dom.innerHTML).toEqual("foobar");
            });
