describe("Ext.util.JSON", function() {
    var nativeJson;
    ...
    describe("encode", function() {
        ...
        describe("object encoding", function() {
            ...
            it("should not encode dom object", function() {
               expect(encode(Ext.getBody().dom)).toBeUndefined();
            });
        });
    ...
    describe("aliases", function() {
        it("should alias Ext.util.JSON.decode with Ext.decode", function() {
            expect(Ext.decode).toBe(Ext.util.JSON.decode);
        });

        it("should alias Ext.util.JSON.encode with Ext.encode", function() {
            expect(Ext.encode).toBe(Ext.util.JSON.encode);
        });
    });
});
