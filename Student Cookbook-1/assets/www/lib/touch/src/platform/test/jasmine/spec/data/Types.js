    ...
    describe("AUTO", function(){
        ...
        describe("convert", function(){
            it("should not convert undefined", function(){
                expect(conv(type, null, undefined)).toBeUndefined();
            });
            ...
            it("should not convert float", function(){
            ...
            it("should not convert date", function(){
                var d = new Date();
                expect(conv(type, null, d)).toEqual(d);
            });
            
            it("should not convert boolean value", function(){
        ...
        describe("convert", function() {
            ...
            describe("invalid", function() {
                ...
                it("should convert undefined to null", function() {
                    expect(conv(type, {useNull: true}, undefined)).toBeNull();
                });
                
                it("should convert null to null", function() {
                    expect(conv(type, {useNull: true}, null)).toBeNull();
                });
                
                it("should convert empty string to null", function() {
                    expect(conv(type, {useNull: true}, "")).toBeNull();
                });
            });
    ...
    describe("DATE", function(){
        ...
        describe("convert", function() {
            ...
            describe("expected", function() {
                ...
                // TODO: reenable when parseDate will be available in platform
                //it("should convert custom date format", function() {
                //    var format = 'Y-m-d',
                //        val = '1986-03-03',
                //        d = Date.parseDate(val, format);
                //        
                //    expect(conv(type, {dateFormat: format}, n).getTime()).toEqual(d.getTime());                        
                //});
