...
// Pages loaded into the ChildBrowser can execute callback scripts, so be
// careful to
...
// Note: this plugin does NOT install itself, call this method some time after
// deviceready to install it
// it will be returned, and also available globally from
